 ...
 * @type {Object}
 */
var uaStore = exports.uaStore = getLocalStore('ua');
 ...
 * @type {Object}
 */
var uuidStore = exports.uuidStore = getLocalStore('uuid');
...
var bindEvent = exports.bindEvent = function () {
    var _ref10 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee9(target, event, fn) {
    ...
    return function bindEvent(_x17, _x18, _x19) {
...
function until(fn) {
    ...
    return new _promise2.default(function (resolve) {
        var timer = setInterval((0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee10() {
...
function _getConnection(dbInfo, upgradeNeeded) {
    return new Promise$1(function (resolve, reject) {
        ...
        // console.log('——————————open', dbInfo.name, upgradeNeeded);

        var openreq = idb.open.apply(idb, dbArgs);
        // var openreq = idb.open(dbInfo.name);
        ...
        openreq.onsuccess = function () {
          // if (upgradeNeeded) {
            // console.log('——————————success', upgradeNeeded)
          // }
...
// console.log('-----_initStorage00----');
    // Initialize the connection process only when
    // all the related localForages aren't pending.
    return Promise$1.all(initPromises).then(function () {
      // console.log('-----_initStorage11----');
        dbInfo.db = dbContext.db;
        // Get the connection or open a new one without upgrade.
        return _getOriginalConnection(dbInfo);
    }).then(function (db) {
      // console.log('-----_initStorage22----');
        dbInfo.db = db;
...
var SRC = __webpack_require__(151)('src');
var TO_STRING = 'toString';
var $toString = Function[TO_STRING];
var TPL = ('' + $toString).split(TO_STRING);

__webpack_require__(139).inspectSource = function (it) {
...
exports.f = __webpack_require__(122) ? gOPD : function getOwnPropertyDescriptor(O, P) {
  O = toIObject(O);
  P = toPrimitive(P, true);
  if (IE8_DOM_DEFINE) try {
    return gOPD(O, P);
...
if (__webpack_require__(122)) {
  ...
  var arrayCopyWithin = __webpack_require__(227);
  var $DP = __webpack_require__(123);
...
var store = shared.store || (shared.store = new (__webpack_require__(235))());
...
var isObject = __webpack_require__(120);
var has = __webpack_require__(128);
var setDesc = __webpack_require__(123).f;
var id = 0;
var isExtensible = Object.isExtensible || function () {
  return true;
};
...
var global = __webpack_require__(114);
var dP = __webpack_require__(123);
var DESCRIPTORS = __webpack_require__(122);
...
var redefine = __webpack_require__(130);
var redefineAll = __webpack_require__(160);
var meta = __webpack_require__(147);
...
module.exports = __webpack_require__(152) || !__webpack_require__(119)(function () {
  var K = Math.random();
  // In FF throws only define methods
  // eslint-disable-next-line no-undef, no-useless-call
  __defineSetter__.call(null, K, function () { /* empty */ });
  delete __webpack_require__(114)[K];
});
...
var defineProperty = __webpack_require__(123).f;
module.exports = function (name) {
  var $Symbol = core.Symbol || (core.Symbol = LIBRARY ? {} : global.Symbol || {});
  if (name.charAt(0) != '_' && !(name in $Symbol)) defineProperty($Symbol, name, { value: wksExt.f(name) });
};
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(136)(Function.call, __webpack_require__(133).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
__webpack_require__(129)(IteratorPrototype, __webpack_require__(121)('iterator'), function () { return this; });
...
module.exports = !__webpack_require__(122) && !__webpack_require__(119)(function () {
...
var $parseInt = __webpack_require__(114).parseInt;
...
var $parseFloat = __webpack_require__(114).parseFloat;
var $trim = __webpack_require__(162).trim;
...
// 21.2.5.3 get RegExp.prototype.flags()
if (__webpack_require__(122) && /./g.flags != 'g') __webpack_require__(123).f(RegExp.prototype, 'flags', {
  configurable: true,
...
var redefineAll = __webpack_require__(160);
var getWeak = __webpack_require__(147).getWeak;
var anObject = __webpack_require__(113);
var isObject = __webpack_require__(120);
var anInstance = __webpack_require__(158);
var forOf = __webpack_require__(159);
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 6:
                                ...
                                (0, _helper.messageFromSWListener)();
                                _context.next = 10;
    ...
    return {
        ...
        main: function main() {
            ...
            return (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4() {
                var getCurrentPosition, watchId;
                return _regenerator2.default.wrap(function _callee4$(_context4) {
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                                ...
                                                while (1) {
                                                    switch (_context.prev = _context.next) {
                                                        case 0:
                                                            ...
                                                            if (!(!position || (0, _helper.isEmpty)(position))) {
                                                                _context.next = 6;
                                                                break;
                                                            }
                                            ...
                                            while (1) {
                                                switch (_context3.prev = _context3.next) {
                                                                ...
                                                                return _regenerator2.default.wrap(function _callee2$(_context2) {
                                                                    while (1) {
                                                                        switch (_context2.prev = _context2.next) {
                                                                            ...
                                                                            case 6:
                                                                                (0, _log.log)('catched the new position');
                                                                                _context2.next = 9;
                                                    ...
                                                    case 3:
                                                        ...
                                                        setTimeout(function () {
                                                            if (!done) {
                                                                (0, _log.log)('position has not change or watchPosition timeout');
                                                                return resolve();
                                                            }
                                                        }, 5000);
                                                    ...
                                                    case 8:
                                                        (0, _log.log)('getCurrentPosition and watchId exist');
                                                        _context3.next = 11;
                                                        return (0, _helper.grade)('navigator.geolocation.watchPosition', 1);

                                                    case 11:
                                                        (0, _log.log)('-- navigator.geolocation.watchPosition done --', 1);
                                                        // clearWatch
    ...
    return {
        ...
        main: function main() {
            ...
            return (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
                ...
                }, _callee, _this, [[7, 39], [44, 55]]);
            }))();
        },
        error: function error(e) {
            (0, _log.log)('indexeddb: catch unhandled error', e + '');
        }
    };
};
...
var CHECK_LIST = [
// 'lifecycle',
'navigator.serviceWorker', 'navigator.serviceWorker.ready', 'oncontrollerchange', 'onstatechange', 'onupdatefound', 'Registered', 'Unregistered',
// 'clients.claim',
                ...
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 17:
                                _context.next = 19;
                                return (0, _helper.grade)('Notification', 1);
                            ...
                            case 23:
                                ...
                                _context.next = 27;
                                return (0, _helper.grade)('notification.requestPermission', 1);
                            ...
                            case 46:
                                _context.next = 48;
                                return (0, _helper.grade)('showNotification', 1);
                            ...
                            case 51:
                                ...
                                _context.next = 54;
                                return (0, _helper.grade)('getNotification', 1);
                                        ...
                                        while (1) {
                                            switch (_context2.prev = _context2.next) {
                                                case 0:
                                                    ...
                                                    _context2.next = 3;
                                                    return (0, _helper.grade)('main-msg-got', 0.8);
                                                ...
                                                case 3:
                                                    ...
                                                    _context2.next = 8;
                                                    return (0, _helper.grade)(data.feature, data.score || 0);
                                    ...
                                    while (1) {
                                        switch (_context3.prev = _context3.next) {
                                            case 0:
                                                console.error(error);
                                                _context3.next = 3;
                                                return (0, _helper.grade)('main-msg-got', 0);
                                    ...
                                    while (1) {
                                        switch (_context4.prev = _context4.next) {
                                            case 0:
                                                ...
                                                _context4.next = 3;
                                                return (0, _helper.grade)('main-msg-got', 0.5);
                                    ...
                                    while (1) {
                                        switch (_context5.prev = _context5.next) {
                                            case 0:
                                                ...
                                                _context5.next = 3;
                                                return (0, _helper.grade)('main-msg-got', 1);
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 10:
                                ...
                                _context.next = 14;
                                return (0, _helper.grade)('main-msg-send', 1);
                            ...
                            case 17:
                                ...
                                _context.next = 23;
                                return (0, _helper.grade)('main-msg-send', 0.5);
    ...
    return {
        ...
        main: function main() {
            ...
            return (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                ...
                                (0, _log.log)('applicationServerKey:', applicationServerKey);
                            ...
                            case 19:
                                _context3.next = 21;
                                return (0, _helper.grade)('pushManager', 1);
                            ...
                            case 25:
                                permissionState = _context3.sent;
                                _context3.next = 28;
                                return (0, _helper.grade)('pushManager.permissionState', 1);
                            ...
                            case 36:
                                ...
                                (0, _log.log)('Failed to test permissionState: ', _context3.t0);
                                            ...
                                            while (1) {
                                                switch (_context.prev = _context.next) {
                                                    case 0:
                                                        ...
                                                        setTimeout(function () {
                                                            if (!done) {
                                                                (0, _log.log)('pushManager.subscribe timeout');
                                                                resolve();
                                                            }
                                                        }, 5000);
                                                        _context.prev = 2;
                                            ...
                                            while (1) {
                                                switch (_context2.prev = _context2.next) {
                                                    case 0:
                                                        ...
                                                        setTimeout(function () {
                                                            if (!done) {
                                                                (0, _log.log)('pushManager.getSubscription timeout');
                                                                resolve();
                                                            }
                                                        }, 5000);
                                                        _context2.prev = 2;
                            ...
                            case 50:
                                ...
                                _context3.next = 54;
                                return (0, _helper.grade)('pushSubscription.unsubscribe', 1);
                ...
                }, _callee3, _this, [[22, 36]]);
            }))();
        },
        error: function error(e) {
            (0, _log.log)('push: catch unhandled error');
            (0, _log.log)(e + '');
        }
    };
};
...
// uc < 11 / qq < 8.1 can't pass urlB64ToUint8Array();

try {
    applicationServerKey = urlB64ToUint8Array(vapidKeys.publicKey);
} catch (err) {
    (0, _log.log)('error urlB64ToUint8Array', err);
}
...
$export($export.S + $export.F * !__webpack_require__(122), 'Object', { defineProperty: __webpack_require__(123).f });
...
$export($export.S + $export.F * !__webpack_require__(122), 'Object', { defineProperties: __webpack_require__(214) });
...
// 19.1.2.6 Object.getOwnPropertyDescriptor(O, P)
var toIObject = __webpack_require__(132);
var $getOwnPropertyDescriptor = __webpack_require__(133).f;
...
var isObject = __webpack_require__(120);
var meta = __webpack_require__(147).onFreeze;
...
// 19.2.4.2 name
NAME in FProto || __webpack_require__(122) && dP(FProto, NAME, {
  configurable: true,
  get: function () {
    try {
...
var fails = __webpack_require__(119);
var gOPN = __webpack_require__(156).f;
var gOPD = __webpack_require__(133).f;
var dP = __webpack_require__(123).f;
var $trim = __webpack_require__(162).trim;
var NUMBER = 'Number';
...
if (!$Number(' 0o1') || !$Number('0b1') || $Number('+0x1')) {
  ...
  for (var keys = __webpack_require__(122) ? gOPN(Base) : (
    // ES3:
...
var $export = __webpack_require__(12);
var _isFinite = __webpack_require__(114).isFinite;
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(129)(proto, TO_PRIMITIVE, __webpack_require__(348));
...
$export($export.P + $export.F * (__webpack_require__(165) != Object || !__webpack_require__(138)(arrayJoin)), 'Array', {
...
$export($export.P + $export.F * (fails(function () {
  ...
  test.sort(null);
  // Old WebKit
}) || !__webpack_require__(138)($sort)), 'Array', {
...
var $export = __webpack_require__(12);
var $forEach = __webpack_require__(144)(0);
var STRICT = __webpack_require__(138)([].forEach, true);
...
var $export = __webpack_require__(12);
var $map = __webpack_require__(144)(1);

$export($export.P + $export.F * !__webpack_require__(138)([].map, true), 'Array', {
...
var $export = __webpack_require__(12);
var $filter = __webpack_require__(144)(2);

$export($export.P + $export.F * !__webpack_require__(138)([].filter, true), 'Array', {
...
var $export = __webpack_require__(12);
var $some = __webpack_require__(144)(3);

$export($export.P + $export.F * !__webpack_require__(138)([].some, true), 'Array', {
...
var $export = __webpack_require__(12);
var $every = __webpack_require__(144)(4);

$export($export.P + $export.F * !__webpack_require__(138)([].every, true), 'Array', {
...
$export($export.P + $export.F * !__webpack_require__(138)([].reduce, true), 'Array', {
...
$export($export.P + $export.F * !__webpack_require__(138)([].reduceRight, true), 'Array', {
...
$export($export.P + $export.F * (NEGATIVE_ZERO || !__webpack_require__(138)($native)), 'Array', {
...
__webpack_require__(148)('copyWithin');
...
var $export = __webpack_require__(12);
var $find = __webpack_require__(144)(5);
var KEY = 'find';
var forced = true;
...
var $export = __webpack_require__(12);
var $find = __webpack_require__(144)(6);
var KEY = 'findIndex';
var forced = true;
// Shouldn't skip holes
if (KEY in []) Array(1)[KEY](function () { forced = false; });
...
if (__webpack_require__(122) && (!CORRECT_NEW || __webpack_require__(119)(function () {
...
Wrapper = __webpack_require__(139)[PROMISE];
...
__webpack_require__(177)(WEAK_SET, function (get) {
...
var toLength = __webpack_require__(124);
var isObject = __webpack_require__(120);
var ArrayBuffer = __webpack_require__(114).ArrayBuffer;
var speciesConstructor = __webpack_require__(176);
var $ArrayBuffer = buffer.ArrayBuffer;
var $DataView = buffer.DataView;
...
__webpack_require__(145)('Int8', 1, function (init) {
...
__webpack_require__(145)('Uint8', 1, function (init) {
...
__webpack_require__(145)('Int16', 2, function (init) {
...
__webpack_require__(145)('Uint16', 2, function (init) {
...
__webpack_require__(145)('Int32', 4, function (init) {
...
__webpack_require__(145)('Uint32', 4, function (init) {
...
__webpack_require__(145)('Float32', 4, function (init) {
...
__webpack_require__(145)('Float64', 8, function (init) {
...
var aFunction = __webpack_require__(127);
var anObject = __webpack_require__(113);
var rApply = (__webpack_require__(114).Reflect || {}).apply;
...
var $export = __webpack_require__(12);
var $includes = __webpack_require__(169)(true);
...
__webpack_require__(148)('includes');
...
__webpack_require__(148)('flatMap');
...
__webpack_require__(148)('flatten');
...
// https://github.com/tc39/proposal-string-pad-start-end
var $export = __webpack_require__(12);
var $pad = __webpack_require__(240);
...
var toLength = __webpack_require__(124);
var isRegExp = __webpack_require__(172);
var getFlags = __webpack_require__(174);
...
var $export = __webpack_require__(12);
var $values = __webpack_require__(241)(false);
...
// https://github.com/tc39/proposal-object-values-entries
var $export = __webpack_require__(12);
var $entries = __webpack_require__(241)(true);
...
__webpack_require__(122) && $export($export.P + __webpack_require__(179), 'Object', {
...
__webpack_require__(181)('WeakSet');
...
$export($export.G, { global: __webpack_require__(114) });
...
$export($export.S, 'System', { global: __webpack_require__(114) });
...
// https://rwaldron.github.io/proposal-math-extensions/
var $export = __webpack_require__(12);
var scale = __webpack_require__(244);
...
$export($export.S, 'Math', { scale: __webpack_require__(244) });
...
var metadata = __webpack_require__(146);
var anObject = __webpack_require__(113);
...
var $export = __webpack_require__(12);
var microtask = __webpack_require__(206)();
var process = __webpack_require__(114).process;
var isNode = __webpack_require__(137)(process) == 'process';
...
var $export = __webpack_require__(12);
var $task = __webpack_require__(205);
...
module.exports = __webpack_require__(139).RegExp.escape;
...
var _axios = __webpack_require__(468);
...
var _featureList = __webpack_require__(263);

var _uaParserJs = __webpack_require__(488);
...
window.schedulePerCase = function (_ref) {
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 2:
                            ...
                            totalTestDone++;
                            rate = parseInt(totalTestDone / totalTestNum * 100, 10) + '%';
...
function refreshScorePerFeature(feature, score) {
    var midScore = totalTestScore >= totalTestNum ? totalTestScore : totalTestScore + score;
    var midDone = totalTestDone >= totalTestNum ? totalTestDone : totalTestDone + 1;
    var rate = parseInt(midDone / totalTestNum * 100, 10) + '%';
    totalSchedule.innerHTML = rate;
    ...
    */
    ...
    if (typeof(exports) !== UNDEF_TYPE) {
        ...
        */
        ...
        if ("function" === FUNC_TYPE && __webpack_require__(489)) {
...
var _demo = __webpack_require__(250);
...
var SCOPE = "/pwa-features-autotest-test" + '/cases/cache/';
...
var _demo = __webpack_require__(251);
...
var SCOPE = "/pwa-features-autotest-test" + '/cases/client/';
...
var _demo = __webpack_require__(252);
...
var _demo = __webpack_require__(253);
...
var SCOPE = "/pwa-features-autotest-test" + '/cases/deviceapi/';
...
var SCOPE = "/pwa-features-autotest-test" + '/cases/fetch/';
...
var _demo = __webpack_require__(255);
...
var SCOPE = "/pwa-features-autotest-test" + '/cases/getregistration/';
...
var _demo = __webpack_require__(256);
...
var SCOPE = "/pwa-features-autotest-test" + '/cases/indexeddb/';
...
var _demo = __webpack_require__(257);
 ...
 * @author ruoran (liuruoran@baidu.com)
 */
var SCOPE = "/pwa-features-autotest-test" + '/cases/lifecycle/';
...
var _demo = __webpack_require__(258);
...
var SCOPE = "/pwa-features-autotest-test" + '/cases/notification/';
...
var _demo = __webpack_require__(259);
...
var SCOPE = "/pwa-features-autotest-test" + '/cases/payment/';
...
var _demo = __webpack_require__(260);
...
var SCOPE = "/pwa-features-autotest-test" + '/cases/postmessage/';
...
var _demo = __webpack_require__(261);
...
var SCOPE = "/pwa-features-autotest-test" + '/cases/push/';
...
var _demo = __webpack_require__(262);
...
var SCOPE = "/pwa-features-autotest-test" + '/cases/sync/';
 ...
 * @author clark-t (clarktanglei@163.com)
 */
var files = __webpack_require__(517);

var caseList = files.keys().map(function (key) {
    return key.slice(1).replace(/js$/, 'html');
}).map(function (key) {
    return "/pwa-features-autotest-test" + '/cases' + key;
});
...
var map = {
	"./cache/index.js": 490,
	"./client/index.js": 491,
	"./credentials/index.js": 492,
	"./deviceapi/index.js": 493,
	"./fetch/index.js": 494,
	"./getregistration/index.js": 495,
	"./indexeddb/index.js": 496,
	"./lifecycle/index.js": 497,
	"./notification/index.js": 498,
	"./payment/index.js": 499,
	"./postmessage/index.js": 500,
	"./push/index.js": 501,
	"./sync/index.js": 502
};
