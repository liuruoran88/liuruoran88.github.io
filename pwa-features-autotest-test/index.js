                                ...
                                return _regenerator2.default.wrap(function _callee14$(_context14) {
                                    while (1) {
                                        switch (_context14.prev = _context14.next) {
                                            case 0:
                                                (0, _log.log)('Got message via navigator.serviceWorker', event.data);
                                                _context14.next = 3;
...
var Symbol = __webpack_require__(111).Symbol;
var USE_SYMBOL = typeof Symbol == 'function';
...
if (__webpack_require__(115)) {
  ...
  var uid = __webpack_require__(144);
  var wks = __webpack_require__(114);
...
var has = __webpack_require__(121);
var TAG = __webpack_require__(114)('toStringTag');
...
module.exports = __webpack_require__(145) || !__webpack_require__(112)(function () {
  var K = Math.random();
...
var isObject = __webpack_require__(113);
var document = __webpack_require__(111).document;
// typeof document.createElement is 'object' in old IE
var is = isObject(document) && isObject(document.createElement);
module.exports = function (it) {
  return is ? document.createElement(it) : {};
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(129)(Function.call, __webpack_require__(126).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
__webpack_require__(122)(IteratorPrototype, __webpack_require__(114)('iterator'), function () { return this; });
...
module.exports = !__webpack_require__(115) && !__webpack_require__(112)(function () {
...
// 21.2.5.3 get RegExp.prototype.flags()
if (__webpack_require__(115) && /./g.flags != 'g') __webpack_require__(116).f(RegExp.prototype, 'flags', {
  configurable: true,
...
var gOPS = __webpack_require__(163);
var anObject = __webpack_require__(110);
var Reflect = __webpack_require__(111).Reflect;
...
var toLength = __webpack_require__(117);
var ctx = __webpack_require__(129);
var IS_CONCAT_SPREADABLE = __webpack_require__(114)('isConcatSpreadable');
...
var getKeys = __webpack_require__(146);
var toIObject = __webpack_require__(125);
var isEnum = __webpack_require__(159).f;
...
var _indexeddb = __webpack_require__(178);
...
$export($export.S + $export.F * !__webpack_require__(115), 'Object', { defineProperty: __webpack_require__(116).f });
...
$export($export.S + $export.F * !__webpack_require__(115), 'Object', { defineProperties: __webpack_require__(210) });
...
var isObject = __webpack_require__(113);
var getPrototypeOf = __webpack_require__(127);
var HAS_INSTANCE = __webpack_require__(114)('hasInstance');
...
var $export = __webpack_require__(11);
var _isFinite = __webpack_require__(111).isFinite;
...
var $export = __webpack_require__(11);
var toLength = __webpack_require__(117);
var context = __webpack_require__(193);
...
__webpack_require__(124)('anchor', function (createHTML) {
...
__webpack_require__(124)('big', function (createHTML) {
  return function big() {
...
__webpack_require__(124)('blink', function (createHTML) {
...
__webpack_require__(124)('bold', function (createHTML) {
...
__webpack_require__(124)('fixed', function (createHTML) {
...
__webpack_require__(124)('fontcolor', function (createHTML) {
...
__webpack_require__(124)('fontsize', function (createHTML) {
...
__webpack_require__(124)('italics', function (createHTML) {
...
__webpack_require__(124)('link', function (createHTML) {
...
__webpack_require__(124)('small', function (createHTML) {
...
__webpack_require__(124)('strike', function (createHTML) {
...
__webpack_require__(124)('sub', function (createHTML) {
  return function sub() {
...
__webpack_require__(124)('sup', function (createHTML) {
  return function sup() {
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(122)(proto, TO_PRIMITIVE, __webpack_require__(348));
...
$export($export.P + $export.F * (__webpack_require__(158) != Object || !__webpack_require__(131)(arrayJoin)), 'Array', {
...
var $export = __webpack_require__(11);
var $forEach = __webpack_require__(137)(0);
var STRICT = __webpack_require__(131)([].forEach, true);
...
var $export = __webpack_require__(11);
var $map = __webpack_require__(137)(1);

$export($export.P + $export.F * !__webpack_require__(131)([].map, true), 'Array', {
...
var $export = __webpack_require__(11);
var $filter = __webpack_require__(137)(2);

$export($export.P + $export.F * !__webpack_require__(131)([].filter, true), 'Array', {
...
$export($export.P + $export.F * !__webpack_require__(131)([].some, true), 'Array', {
...
var $export = __webpack_require__(11);
var $every = __webpack_require__(137)(4);

$export($export.P + $export.F * !__webpack_require__(131)([].every, true), 'Array', {
...
$export($export.P + $export.F * !__webpack_require__(131)([].reduce, true), 'Array', {
...
$export($export.P + $export.F * !__webpack_require__(131)([].reduceRight, true), 'Array', {
...
$export($export.P + $export.F * (NEGATIVE_ZERO || !__webpack_require__(131)($native)), 'Array', {
...
var $export = __webpack_require__(11);
var $find = __webpack_require__(137)(5);
var KEY = 'find';
var forced = true;
...
var $export = __webpack_require__(11);
var $find = __webpack_require__(137)(6);
var KEY = 'findIndex';
var forced = true;
// Shouldn't skip holes
if (KEY in []) Array(1)[KEY](function () { forced = false; });
...
if (__webpack_require__(115) && (!CORRECT_NEW || __webpack_require__(112)(function () {
...
__webpack_require__(150)('RegExp');
...
var USE_NATIVE = !!function () {
  try {
    // correct subclassing with @@species support
    var promise = $Promise.resolve(1);
    var FakePromise = (promise.constructor = {})[__webpack_require__(114)('species')] = function (exec) {
      exec(empty, empty);
    };
    // unhandled rejections tracking support, NodeJS Promise without it fails @@species test
    return (isNode || typeof PromiseRejectionEvent == 'function') && promise.then(empty) instanceof FakePromise;
...
var toLength = __webpack_require__(117);
var isObject = __webpack_require__(113);
var ArrayBuffer = __webpack_require__(111).ArrayBuffer;
var speciesConstructor = __webpack_require__(169);
var $ArrayBuffer = buffer.ArrayBuffer;
var $DataView = buffer.DataView;
...
__webpack_require__(138)('Int8', 1, function (init) {
...
__webpack_require__(138)('Uint8', 1, function (init) {
...
__webpack_require__(138)('Int16', 2, function (init) {
...
__webpack_require__(138)('Uint16', 2, function (init) {
...
__webpack_require__(138)('Int32', 4, function (init) {
...
__webpack_require__(138)('Uint32', 4, function (init) {
...
__webpack_require__(138)('Float32', 4, function (init) {
...
__webpack_require__(138)('Float64', 8, function (init) {
...
var aFunction = __webpack_require__(120);
var anObject = __webpack_require__(110);
var rApply = (__webpack_require__(111).Reflect || {}).apply;
...
var rConstruct = (__webpack_require__(111).Reflect || {}).construct;
...
var $export = __webpack_require__(11);
var getProto = __webpack_require__(127);
var anObject = __webpack_require__(110);
...
__webpack_require__(141)('includes');
...
__webpack_require__(141)('flatMap');
...
__webpack_require__(141)('flatten');
...
var $export = __webpack_require__(11);
var $values = __webpack_require__(237)(false);
...
__webpack_require__(115) && $export($export.P + __webpack_require__(172), 'Object', {
...
__webpack_require__(173)('WeakMap');
...
__webpack_require__(173)('WeakSet');
...
$export($export.G, { global: __webpack_require__(111) });
...
$export($export.S, 'Math', { scale: __webpack_require__(240) });
...
var metadata = __webpack_require__(139);
var anObject = __webpack_require__(110);
...
var $export = __webpack_require__(11);
var microtask = __webpack_require__(202)();
var process = __webpack_require__(111).process;
var isNode = __webpack_require__(130)(process) == 'process';
...
var core = __webpack_require__(132);
var microtask = __webpack_require__(202)();
var OBSERVABLE = __webpack_require__(114)('observable');
var aFunction = __webpack_require__(120);
var anObject = __webpack_require__(110);
var anInstance = __webpack_require__(151);
var redefineAll = __webpack_require__(153);
...
module.exports = __webpack_require__(132).RegExp.escape;
...
function refreshScorePerFeature(feature, score) {
    var midScore = totalTestScore + score;
    var midDone = totalTestDone + 1;
...
var _demo = __webpack_require__(246);
...
var _demo = __webpack_require__(247);
...
var _demo = __webpack_require__(248);
